...
namespace DocSpring.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "docspring-csharp-#{VERSION}";
            BasePath = "https://api.docspring.com/api/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.docspring.com/api/v1") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "docspring-csharp-#{VERSION}"
        ...
        {
            String report = "C# SDK (DocSpring.Client) Debug Report:\n";
