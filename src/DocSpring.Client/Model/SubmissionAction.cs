...
namespace DocSpring.Client.Model
{
    ...
    /// SubmissionAction
    /// </summary>
    [DataContract(Name = "submission_action")]
    public partial class SubmissionAction : IValidatableObject
    {
        /// <summary>
        /// Defines State
        /// </summary>
        ...
        public SubmissionAction(string id = default(string), string integrationId = default(string), StateEnum state = default(StateEnum), ActionTypeEnum actionType = default(ActionTypeEnum), ActionCategoryEnum actionCategory = default(ActionCategoryEnum), Object resultData = default(Object))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for SubmissionAction and cannot be null");
            }
            this.Id = id;
            // to ensure "integrationId" is required (not null)
            if (integrationId == null)
            {
                throw new ArgumentNullException("integrationId is a required property for SubmissionAction and cannot be null");
            }
            ...
            if (resultData == null)
            {
                throw new ArgumentNullException("resultData is a required property for SubmissionAction and cannot be null");
            }
