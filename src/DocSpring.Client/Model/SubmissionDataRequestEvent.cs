...
namespace DocSpring.Client.Model
{
    ...
    public partial class SubmissionDataRequestEvent : IValidatableObject
    {
        ...
        public SubmissionDataRequestEvent(string id = default(string), string submissionId = default(string), string submissionDataRequestId = default(string), string eventType = default(string), string messageType = default(string), string messageRecipient = default(string), string occurredAt = default(string))
        {
            ...
            if (eventType == null)
            {
                throw new ArgumentNullException("eventType is a required property for SubmissionDataRequestEvent and cannot be null");
            }
            this.EventType = eventType;
            // to ensure "messageType" is required (not null)
            if (messageType == null)
            {
                throw new ArgumentNullException("messageType is a required property for SubmissionDataRequestEvent and cannot be null");
            }
