...
namespace DocSpring.Client.Model
{
    ...
    public partial class SubmissionBatch : IValidatableObject
    {
        ...
        public SubmissionBatch(string id = default(string), StateEnum state = default(StateEnum), Object metadata = default(Object), string processedAt = default(string), int totalCount = default(int), int pendingCount = default(int), int errorCount = default(int), decimal completionPercentage = default(decimal))
        {
