...
namespace DocSpring.Client.Model
{
    ...
    /// UpdateTemplateData
    /// </summary>
    [DataContract(Name = "update_template_data")]
    public partial class UpdateTemplateData : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateTemplateData(TemplateData template = default(TemplateData))
        {
            ...
            if (template == null)
            {
                throw new ArgumentNullException("template is a required property for UpdateTemplateData and cannot be null");
            }
