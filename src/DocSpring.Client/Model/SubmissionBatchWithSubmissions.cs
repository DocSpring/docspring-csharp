...
namespace DocSpring.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "submission_batch_with_submissions")]
    public partial class SubmissionBatchWithSubmissions : IValidatableObject
    {
        /// <summary>
        /// Defines State
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubmissionBatchWithSubmissions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubmissionBatchWithSubmissions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubmissionBatchWithSubmissions" /> class.
        /// </summary>
        ...
        public SubmissionBatchWithSubmissions(string id = default(string), StateEnum state = default(StateEnum), Object metadata = default(Object), string processedAt = default(string), int totalCount = default(int), int pendingCount = default(int), int errorCount = default(int), decimal completionPercentage = default(decimal), List<SubmissionPreview> submissions = default(List<SubmissionPreview>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for SubmissionBatchWithSubmissions and cannot be null");
            }
            this.Id = id;
            this.State = state;
            ...
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for SubmissionBatchWithSubmissions and cannot be null");
            }
            this.Metadata = metadata;
            // to ensure "processedAt" is required (not null)
            if (processedAt == null)
            {
                throw new ArgumentNullException("processedAt is a required property for SubmissionBatchWithSubmissions and cannot be null");
            }
        ...
        public List<SubmissionPreview> Submissions { get; set; }
