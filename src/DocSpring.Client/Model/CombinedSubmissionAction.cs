...
namespace DocSpring.Client.Model
{
    ...
    public partial class CombinedSubmissionAction : IValidatableObject
    {
        ...
        public CombinedSubmissionAction(string id = default(string), string integrationId = default(string), StateEnum state = default(StateEnum), ActionTypeEnum actionType = default(ActionTypeEnum), ActionCategoryEnum actionCategory = default(ActionCategoryEnum), Object resultData = default(Object))
        {
