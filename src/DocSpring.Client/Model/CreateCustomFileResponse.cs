...
namespace DocSpring.Client.Model
{
    ...
    public partial class CreateCustomFileResponse : IValidatableObject
    {
        ...
        public CreateCustomFileResponse(StatusEnum status = default(StatusEnum), List<string> errors = default(List<string>), Object customFile = default(Object))
        {
            this.Status = status;
        ...
        public Object CustomFile { get; set; }
