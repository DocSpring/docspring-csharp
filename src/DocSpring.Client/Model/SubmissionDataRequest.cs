...
namespace DocSpring.Client.Model
{
    ...
    public partial class SubmissionDataRequest : IValidatableObject
    {
        ...
        public SubmissionDataRequest(string id = default(string), string submissionId = default(string), string name = default(string), string email = default(string), int order = default(int), int sortOrder = default(int), List<string> fields = default(List<string>), Object metadata = default(Object), StateEnum state = default(StateEnum), string viewedAt = default(string), string completedAt = default(string), AuthTypeEnum? authType = default(AuthTypeEnum?), AuthSecondFactorTypeEnum? authSecondFactorType = default(AuthSecondFactorTypeEnum?), string authProvider = default(string), string authSessionStartedAt = default(string), string authSessionIdHash = default(string), string authUserIdHash = default(string), string authUsernameHash = default(string), string authPhoneNumberHash = default(string), string ipAddress = default(string), string userAgent = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "viewed_at", EmitDefaultValue = true)]
