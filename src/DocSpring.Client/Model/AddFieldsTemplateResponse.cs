...
namespace DocSpring.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "add_fields_template_response")]
    public partial class AddFieldsTemplateResponse : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        protected AddFieldsTemplateResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddFieldsTemplateResponse" /> class.
        /// </summary>
        ...
        public AddFieldsTemplateResponse(StatusEnum status = default(StatusEnum), List<string> errors = default(List<string>), List<int> newFieldIds = default(List<int>))
        {
            this.Status = status;
            this.Errors = errors;
