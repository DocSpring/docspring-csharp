...
namespace DocSpring.Client.Test
{
    ...
    /// </remarks>
    [TestFixture]
    public class UploadTemplateDataTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" UploadTemplateData
            //Assert.IsInstanceOfType<UploadTemplateData> (instance, "variable 'instance' is a UploadTemplateData");
        }
